...
func (f *ClientFactory) CreateRESTConfig(cfg model.KubeConfig) (*rest.Config, error) {
...
func (f *ClientFactory) ResolveNamespace(cfg *model.KubeConfig, defaultNS string) string {
	if cfg.Namespace != "" {
